    ...
    <body>
        ...
        <div class="envelope">
            <form action="saveRoute" method="post" name="myForm" onsubmit="return myValidation()">
                ...
                <input name="vReg" placeholder="Vehicle Registration No." type="text" width="100px;">
                <label>Bus Number</label>
                <input name="Bno" placeholder="Bus Number" type="text" width="100px;">
                <label>Driver Name</label>
                <input name="dName" placeholder="yourname@gmail.com" type="text">
                <label>Driver Contact Number</label>
                <input name="contact" placeholder="+91-" type="text">
                <label>Capacity</label>
                <input name="caps" placeholder="Number" type="text">
                <label>Starting Point</label>
                <input type="text" name="sPoint" placeholder="Starting Point">
                <label>Travelling Cost</label>
