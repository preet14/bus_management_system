<%-- 
    Document   : allFacultyInfo
    Created on : Apr 2, 2019, 6:59:04 PM
    Author     : user
--%>
...
<nav>
    ...
    <a class="active" href="getAllFaculty">Faculty Information</a>
...
<table>
    <%
       int i=0;
       ArrayList<Faculty> ri = (ArrayList<Faculty>)session.getAttribute("fi");
       if(ri!=null && ri.size()!=0){
           System.out.println("innnnner");
           
    %>
  <caption>View Faculty Details</caption>
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Delete"><a href="delFact?fid=<%= ri.get(i).getRoll() %>">Delete</a></td>
    </tr>
    <%
        }
        }
