<%-- 
    Document   : ResultSearchFaculty
    Created on : Mar 25, 2019, 8:56:19 PM
    Author     : user
--%>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Starting Point"><%= (ri.get(i)).getSpoint() %> <a href="vwStoppageFaculty?rtName=<%=(ri.get(i)).getRoutename()%>">( List More )</a></td>
