<%-- 
    ...
    Created on : Mar 25, 2019, 12:13:25 PM
    Author     : user
--%>
...
<nav>
  ...
  <a class="active" href="FactProfile?rno=<%= r %>">Profile</a>
...
<table>
 <%
       int i=0;
       ArrayList<Faculty> ri = (ArrayList<Faculty>)session.getAttribute("sprof");
 ...
 %>
  ...
  <tbody>
    <tr>
      <td data-label="Faculty Id"><%= (ri.get(i)).getRoll() %></td>
